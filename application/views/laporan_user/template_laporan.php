          ...
          ================================================= -->
              ...
              ================================================= -->
                    <div class="create-post">
                        <div class="row">
                            ...
                            <div class="col-md-5 col-sm-5">
                                <div class="tools">
                                    <button class="btn btn-primary pull-right" onclick="loadMenu('<?= base_url('laporan_user/form_create') ?>')"> Buat Laporan </button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="create-post">
                        <div class="row">
                            ...
                            <ol type:'1'>
                                <div class="form-group">
                                    <p>Berikut ini sekilas tata cara pengurusan Laporan Kehilangan Barang pada pihak Kepolisian yang mungkin anda perlu ketahui.</p> <br>
                                </div>
                                <li>
                                    <div class="form-group">
                                        <p>Periksa dan Coba Ingat kembali dimana barang yang hilang itu terahir anda ketahui lokasinya.</p> <br>
                                    </div>
                                </li>
                                <li>
                                    <div class="form-group">
                                        <p> Jika dirasa barang milik anda benar-benar hilang maka segeralah bergegas melapor di website ini dengan klik buat laporan, kemudian pilih kantor polisi terdekat anda yang akan di beri laporan kehilangan serta isi data secara lengkap.</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="form-group">
                                        <p> Kemudian unggah laporan dan tunggu proses selanjutnya.</p>
                                    </div>
                                </li>
                        </div>
                    </div>
              ...
              ================================================= -->
                    ...
                    <div class="post-content">
                        <!-- <img src="<?= base_url('assets/findit/') ?>images/post-images/sleman.jpg" alt="post-image" class="img-responsive post-image" /> -->
